...
1. Navigate to the CAD File/ directory in this repository.
2. Download all compressed archive volumes (3D CAD File\_Part 1.zip through 3D CAD File\_Part 5.zip).
3. Extract all zip volumes into a single, shared directory on your local machine.
4. Open your 3D CAD modeling software solidworks.
5. Locate and open the primary top-level assembly file named right arm assembly (or its corresponding extension file). This will load the fully mated, multi-joint linkage structure including the hand, forearm, and geared shoulder stages.



#### Actuator to Driver Connections

1. Macro-Joint Stepper Motors (Shoulder Yaw \& Pitch): Connect the 4-wire pairs (A+, A-, B+, B-) of your NEMA 23 stepper motors directly to the corresponding terminal outputs on their dedicated TB6600 drivers.
...
2. Control Logic Interconnections
...
3. Isolated Power Rail Configurations
